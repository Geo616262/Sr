...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} Ganastes: +1209 exp` : isTie ? 'El juego termino empate 😐' : `Turno de: @${room.game.currentTurn.split('@')[0]}`}
`.trim();
